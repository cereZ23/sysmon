...
#
#   | Event ID | Descrizione                  | Criticità  | Policy Source                    |
#   |----------|------------------------------|------------|----------------------------------|
#   | 4625     | Failed Logon (Brute Force)   | 🔴 CRITICO | Logon                            |
#   | 4771     | Kerberos Pre-Auth Failed     | 🔴 CRITICO | Kerberos Authentication Service  |
#   | 4776     | NTLM Auth Failed             | 🔴 CRITICO | Credential Validation            |
#   | 4720     | User Account Created         | 🔴 CRITICO | User Account Management          |
#   | 4722     | User Account Enabled         | 🟠 ALTO    | User Account Management          |
#   | 4724     | Password Reset Attempt       | 🟠 ALTO    | User Account Management          |
#   | 4728     | User Added to Security Group | 🔴 CRITICO | Security Group Management        |
...
#   | 4769     | Kerberos Service Ticket      | 🟠 ALTO    | Kerberos Service Ticket Ops      |
#   | 4770     | Kerberos Ticket Renewed      | 🟢 MEDIO   | Kerberos Service Ticket Ops      |
#   | 5140     | Network Share Accessed       | 🟠 ALTO    | File Share                       |
#   | 5145     | Network Share Object Access  | 🟠 ALTO    | Detailed File Share              |
#   | 5156     | WFP Connection Allowed       | 🟢 MEDIO   | Filtering Platform Connection    |
#   | 5157     | WFP Connection Blocked       | 🟠 ALTO    | Filtering Platform Connection    |
#
# ============================================================================
